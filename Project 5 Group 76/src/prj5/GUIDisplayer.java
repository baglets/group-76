...
public class GUIDisplayer {
    ...
    /**
     * Default constructor. It takes in the songList generated by DataReader and
     * stores it as a field. It also creates a window and buttons, and it calls
     * two initialization methods to bring up the display of data and the
     * legend.
     * 
     * @param songList
    ...
    /**
     * This method initalizes the shapes and graphical representation of the
     * songs.
     */
    public void initializeShapes() {
        ...
        for (int ySpot = 1; ySpot <= 3; ySpot++) {
            for (int xSpot = 1; xSpot <= 3; xSpot++) {
                ...
                // Iterate the songNumber and get the next song
                songNumber++;
                currentSong = songs.get(songNumber);

                // If there is no next song, exit the loop
                if (currentSong == null) {
                    break;
                }
            }
    ...
    /**
     * This method initializes the legend's shapes and texts.
     */
    ...
    /**
     * This method refreshes the display bars of data. It will use the current
     * songNumber, and it will set the enums to compare to based on the current
     * representation.
     */
    public void refresh() {
        Enum<?> compare1, compare2, compare3, compare4;
